...
docker pull docker.io/library/nginx:lastest（简化后docker pull nginx）
pull命令由4部分组成两个/，docker.io是官方公共仓库地址，可省略官方地址，library是命名空间，也就是作者名字可省略官方作者名字，
nginx:lastest，nginx是要下载的软件，而:后的latest是软件的版本号，可指定某个版本1.28.0，也可不写表示最新版本
例子docker pull docker.n8n.io/n8nio/n8n下一个开源ai工作流工具n8n
